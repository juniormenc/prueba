...
@Component({
  selector: 'reporte-ingresos-citas-especialidad-medico',
  templateUrl: './reporte-ingresos-citas-especialidad-medico.component.html',
  styleUrls: ['./reporte-ingresos-citas-especialidad-medico.component.scss']
})
